...
module.exports = {
    ...
    MONGODB_URI: process.env.MONGODB_URI, "mongodb+srv://didixii_db_user:VeIUTRzLTNDUZTJQ@cluster0.qjubngh.mongodb.net/?appName=Cluster0"
    
    // ===========================================================
    // 2. INFORMATIONS DU BOT
    // ===========================================================
    PREFIX: process.env.PREFIX || '.',
    OWNER_NUMBER: process.env.OWNER_NUMBER || '923402012326', // Mettez votre numéro ici
    BOT_NAME: process.env.BOT_NAME || "ꜱᴀʀᴡᴀʀ_ᴍᴅ",
    BOT_FOOTER: '⚡ © ᴘᴏᴡᴇʀᴇᴅ ʙʏ ꜱᴀʀᴡᴀʀ_ᴍᴅ 🇵🇰',
    ...
    GROUP_INVITE_LINK: process.env.GROUP_INVITE_LINK || 'https://chat.whatsapp.com/HwtstqjPN0X8vujukEmN60',
    ...
    // 7. IMAGES & LIENS
    // ===========================================================
    IMAGE_PATH: 'https://i.ibb.co/yFwFN983/IMG-20260509-WA0045.jpg',
